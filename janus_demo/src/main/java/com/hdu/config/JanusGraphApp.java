...
//        JanusGraphManagement management = graph8.openManagement();
//        management.buildIndex("", Vertex.class).unique().buildCompositeIndex();
//        management.buildIndex("", Edge.class).unique().buildCompositeIndex();
        s.append("JanusGraphManagement management = graph8.openManagement(); ");
